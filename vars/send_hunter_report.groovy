def call(String api_username, String api_token) {
    ...
    sed -i "1 i <h3 style=\'font-family:arial, LINE-HEIGHT:10px\'>Failed Scenarios(${questionable_cases_num}/$total_scenarios_num=${failure_percentage}%)</h3>" owner_scenarios
    cat owner_scenarios
    fi 
    '''
    ...
    sed -i "1 i  <h3 style=\'font-family:arial, LINE-HEIGHT:10px\'>Disabled/Pending Scenarios(${questionable_cases_num}/${total_scenarios_num}=${disable_percentage}%)</h3>" owner_scenarios
    cat owner_scenarios
    fi 
    ''' 
