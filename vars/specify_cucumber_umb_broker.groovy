def call(String etPod){
  ...
  [ umb_config_1, umb_config_2 ].each {
    ...
    run_cmd_against_pod(etPod, change_umb_cmd_1)
    def change_umb_cmd_2="sed -i \"s/ENV\\['ET_UMB_BROKER_URL_2'\\]/'amqp:\\/\\/cucumber-umb-qe:5672'/g\" ${it}"
    run_cmd_against_pod(etPod, change_umb_cmd_2)
  }
  ...
  run_cmd_against_pod(etPod, delay_to_send_message_cmd)
}
